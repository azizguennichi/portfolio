  ...
  return (
    ...
    React JS Application
                    ...
                    <div className='pt-8 text-center'>
                        ...
                        <a href='https://github.com/azizguennichi/projet-web2'>
    ...
    React JS Application
            ...
            <div style={{backgroundImage:`url(${automobile})`}} className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div '>
                {/* Hover Effects*/}
                <div className='opacity-0 group-hover:opacity-100'>
                    <span className='text-2xl font-bold text-white tracking-wider'>
    HTML & CSS
